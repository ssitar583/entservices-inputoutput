...
if curl_response:
    ...
    Utils.error_log("curl command send failed {}" .format(HdmiCecSinkApis.set_routing_change_with_undefined_datatype))
    status = 'False'
    message = 'Output response is not matching with expected one'

# generate logs in terminal
tc_id = 'TCID039_HdmiCecSink_setRoutingChange_with_undefinedDatatypesandRoutingInformation'
