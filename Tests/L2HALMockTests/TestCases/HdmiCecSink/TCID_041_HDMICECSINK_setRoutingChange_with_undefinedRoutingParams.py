# Testcase ID : TCID041_setRoutingChange_withUndefinedDatatypes
# Testcase Description : Changes routing while switching between error inputs and TV. Verify the erroneuos output response
...
print("TC Description - Changes routing while switching between error inputs and TV. Verify the erroneuos output response")
...
curl_response = Utils.send_curl_command(HdmiCecSinkApis.set_routing_change_with_undefined_datatype)
if curl_response:
...
tc_id = 'TCID041_HdmiCecSink_setRoutingChange_with_erroneousRoutingParams'
