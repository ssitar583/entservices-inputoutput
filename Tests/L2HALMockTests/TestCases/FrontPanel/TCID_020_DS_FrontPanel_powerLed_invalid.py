...
# Testcase ID : TCID020_DS_FrontPanel_getBrightness
# Testcase Description : Get the brightness of the specified LED or FrontPanel

from Utilities import Utils, ReportGenerator
from FrontPanel import FrontPanelApis

print("TC Description - Get the brightness of the specified LED or FrontPanel, by specifying a wrong index value in params")
print("---------------------------------------------------------------------------------------------------------------------------")
...
tc_id = 'TCID020_DS_FrontPanel_getBrightnessIndexInvalid'
