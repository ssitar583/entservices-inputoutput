...
print("TC Description - Get the brightness of the specified LED or FrontPanel, set it to 50 then again get the brightness")
print("---------------------------------------------------------------------------------------------------------------------------")
...
tc_id = 'TCID015_DS_FrontPanel_getsetBrightness'
