...
protected:
    ...
    Exchange::IPowerManager::INotification* _notification = nullptr;
        ...
        , _notification(nullptr)
    {
        ...
        EXPECT_CALL(PowerManagerMock::Mock(), Register(::testing::_))
            .WillOnce(
                [this](Exchange::IPowerManager::INotification* notification) -> uint32_t {
...
TEST_F(SystemServicesEventIarmTest, onTemperatureThresholdChangedFailed_withoutValidInstance)
{
    ...
    _notification->OnThermalModeChanged(IPowerManager::THERMAL_TEMPERATURE_CRITICAL, IPowerManager::THERMAL_TEMPERATURE_HIGH, 0);
...
TEST_F(SystemServicesEventIarmTest, onTemperatureThresholdChangedFailed_whenNewLevelEmpty)
{
    ...
    ASSERT_NE(_notification, nullptr);
    _notification->OnThermalModeChanged(IPowerManager::THERMAL_TEMPERATURE_CRITICAL, IPowerManager::THERMAL_TEMPERATURE_UNKNOWN, 0);
...
TEST_F(SystemServicesEventIarmTest, onTemperatureThresholdChangedFailed_currLevelEmpty_newLevelNORMAL)
{
    ...
    ASSERT_NE(_notification, nullptr);
    _notification->OnThermalModeChanged(IPowerManager::THERMAL_TEMPERATURE_UNKNOWN, IPowerManager::THERMAL_TEMPERATURE_NORMAL, 0);
...
TEST_F(SystemServicesEventIarmTest, onTemperatureThresholdChangedFailed_currLevelEmpty_newLevelHIGH)
{
    ...
    ASSERT_NE(_notification, nullptr);
    _notification->OnThermalModeChanged(IPowerManager::THERMAL_TEMPERATURE_UNKNOWN, IPowerManager::THERMAL_TEMPERATURE_HIGH, 0);
...
TEST_F(SystemServicesEventIarmTest, onTemperatureThresholdChangedFailed_currLevelEmpty_newLevelCRITICAL)
{
    ...
    ASSERT_NE(_notification, nullptr);
    _notification->OnThermalModeChanged(IPowerManager::THERMAL_TEMPERATURE_UNKNOWN, IPowerManager::THERMAL_TEMPERATURE_CRITICAL, 0);
...
TEST_F(SystemServicesEventIarmTest, onTemperatureThresholdChangedSuccess_whenNormalToHigh)
{
    ...
    ASSERT_NE(_notification, nullptr);
    _notification->OnThermalModeChanged(IPowerManager::THERMAL_TEMPERATURE_NORMAL, IPowerManager::THERMAL_TEMPERATURE_HIGH, 100.0);
...
TEST_F(SystemServicesEventIarmTest, onTemperatureThresholdChangedSuccess_whenCriticalToHigh)
{
    ...
    ASSERT_NE(_notification, nullptr);
    _notification->OnThermalModeChanged(IPowerManager::THERMAL_TEMPERATURE_CRITICAL, IPowerManager::THERMAL_TEMPERATURE_HIGH, 48);
...
TEST_F(SystemServicesEventIarmTest, onTemperatureThresholdChangedSuccess_whenHighToCritical)
{
    ...
    ASSERT_NE(_notification, nullptr);
    _notification->OnThermalModeChanged(IPowerManager::THERMAL_TEMPERATURE_HIGH, IPowerManager::THERMAL_TEMPERATURE_CRITICAL, 100);
...
TEST_F(SystemServicesEventIarmTest, onTemperatureThresholdChangedSuccess_whenHighToNormal)
{
    ...
    ASSERT_NE(_notification, nullptr);
    _notification->OnThermalModeChanged(IPowerManager::THERMAL_TEMPERATURE_HIGH, IPowerManager::THERMAL_TEMPERATURE_NORMAL, 100);
...
TEST_F(SystemServicesTest, setPowerStateSuccess_when_powerstate_Light_sleep)
{
    EXPECT_CALL(PowerManagerMock::Mock(), SetPowerState(::testing::_, ::testing::_, ::testing::_))
        .WillOnce([](const int& keyCode, const PowerState& powerState, const string& reason) -> uint32_t {
            EXPECT_EQ(powerState, PowerState::POWER_STATE_STANDBY_LIGHT_SLEEP);
            return Core::ERROR_NONE;
        });
...
TEST_F(SystemServicesEventIarmTest, onSystemPowerStateChanged_From_DEEPSLEEP_to_ON)
{
    ...
    ASSERT_NE(_notification, nullptr);
    _notification->OnPowerModeChanged(IPowerManager::POWER_STATE_STANDBY_DEEP_SLEEP, IPowerManager::POWER_STATE_ON);
...
TEST_F(SystemServicesEventIarmTest, onSystemPowerStateChanged_PowerState_STANDBY_To_LIGHTSLEEP)
{
    ...
    ASSERT_NE(_notification, nullptr);
    _notification->OnPowerModeChanged(IPowerManager::POWER_STATE_STANDBY, IPowerManager::POWER_STATE_STANDBY_LIGHT_SLEEP);
...
TEST_F(SystemServicesEventIarmTest, onSystemPowerStateChanged_PowerState_ON_To_DEEPSLEEP)
{
    ...
    ASSERT_NE(_notification, nullptr);
    _notification->OnPowerModeChanged(IPowerManager::POWER_STATE_ON, IPowerManager::POWER_STATE_STANDBY_DEEP_SLEEP);
...
TEST_F(SystemServicesEventIarmTest, onNetworkStandbyModeChanged)
{
    ...
    ASSERT_NE(_notification, nullptr);
    _notification->OnNetworkStandbyModeChanged(true);
...
TEST_F(SystemServicesEventIarmTest, onRebootRequest)
{
    ...
    _notification->OnRebootBegin("reason", "reasonOther", "requestorL1test");
