...
TEST_F(WifiInitializedEventTest, onWIFIStateChanged)
{
    ...
    EVENT_SUBSCRIBE(0, _T("onWIFIStateChanged"), _T("org.rdk.WifiManager"), message);
    plugin->onWIFIStateChanged(intData,false);
    EVENT_UNSUBSCRIBE(0, _T("onWIFIStateChanged"), _T("org.rdk.WifiManager"), message);
 }
...
TEST_F(WifiInitializedEventTest, onSSIDsChanged)
{
    ...
    EVENT_SUBSCRIBE(0, _T("onSSIDsChanged"), _T("org.rdk.WifiManager"), message);
    plugin->onSSIDsChanged();
    EVENT_UNSUBSCRIBE(0, _T("onSSIDsChanged"), _T("org.rdk.WifiManager"), message);
 }
TEST_F(WifiInitializedEventTest, onWifiSignalThresholdChanged)
{
    ...
    EVENT_SUBSCRIBE(0, _T("onWifiSignalThresholdChanged"), _T("org.rdk.WifiManager"), message);
    plugin->onWifiSignalThresholdChanged(-27.000000,"Excellent");
     EVENT_UNSUBSCRIBE(0, _T("onWifiSignalThresholdChanged"), _T("org.rdk.WifiManager"), message);
}
...
TEST_F(WifiInitializedEventTest, onError)
{
    ...
    EVENT_SUBSCRIBE(0, _T("onError"), _T("org.rdk.WifiManager"), message);
    plugin->onError(intData);
    EVENT_UNSUBSCRIBE(0, _T("onError"), _T("org.rdk.WifiManager"), message);
 }
...
TEST_F(WifiInitializedEventTest, onAvailableSSIDs)
{
    ...
    EVENT_SUBSCRIBE(0, _T("onAvailableSSIDs"), _T("org.rdk.WifiManager"), message);
    plugin->onAvailableSSIDs(jsonObj);
    EVENT_UNSUBSCRIBE(0, _T("onAvailableSSIDs"), _T("org.rdk.WifiManager"), message);
 }
